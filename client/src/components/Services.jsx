  ...
  return (
    <div className="background-hero h-full flex-1 ">
      <div className="mr-10 ml-10 flex justify-between mb-10 items-start">
        ...
        <svg className="" width="147" height="47" viewBox="0 0 147 47" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="3.5" cy="43.5" r="3.5" transform="rotate(-90 3.5 43.5)" fill="white"></circle>
          ...
          <circle cx="53.5" cy="23.5" r="3.5" transform="rotate(-90 53.5 23.5)" fill="white"></circle>
          <circle cx="63.5" cy="23.5" r="3.5" transform="rotate(-90 63.5 23.5)" fill="white"></circle>
          <circle cx="73.5" cy="23.5" r="3.5" transform="rotate(-90 73.5 23.5)" fill="white"></circle>
          <circle cx="83.5" cy="23.5" r="3.5" transform="rotate(-90 83.5 23.5)" fill="white"></circle>
          <circle cx="93.5" cy="23.5" r="3.5" transform="rotate(-90 93.5 23.5)" fill="#FF2000"></circle>
      ...
      <div className="flex mr-10 ml-10 opacity">
        ...
        <div className="card flow-root shadow-xl items-center bg-serv1 ">
          <div className="">
      ...
      <div className="card flow-root shadow-xl items-center bg-serv1 ">
          <div className="">
            <h1 className="text-4xl">WebDevlopment</h1>
          </div>
          <div className=" border border-black rounded-2xl bg-black mt-5 h-40 w-70 bg-opacity-70 ">
            <p className="m-5 text-lg ">qwert asdfgh</p>
          </div>
        </div><div className="card flow-root shadow-xl items-center bg-serv1 ">
          <div className="">
            <h1 className="text-4xl">Automations</h1>
          </div>
          <div className=" border border-black rounded-2xl bg-black mt-5 h-40 w-70 bg-opacity-70 ">
